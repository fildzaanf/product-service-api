...
type UpdateProductRequest struct {
	...
	ImageBytes    []byte                 `protobuf:"bytes,8,opt,name=image_bytes,json=imageBytes,proto3" json:"image_bytes,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_product_proto_rawDesc = "" +
	"\n" +
	"\rproduct.proto\x12\aproduct\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd9\x01\n" +
	...
	"\x0eimage_filename\x18\a \x01(\tR\rimageFilename\x12\x1f\n" +
	"\vimage_bytes\x18\b \x01(\fR\n" +
	"imageBytes\"?\n" +
